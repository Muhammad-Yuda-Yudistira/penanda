    ...
    <div class="col-lg-8">
        ...
        <form action="/bookmarks" method="post">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="slug" aria-describedby="slugHelp" name="slug" disabled>
              <div id="slug" class="form-text">Slug adalah nama yang telah dimodifikasi menjadi huruf kecil semua dan mengganti setiap spasi dengan garis lurus.</div>
            </div>
            <div class="mb-3">
